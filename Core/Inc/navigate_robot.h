...
extern double d6;
  ...
  public:
    ...
    virtual void save_to_file(struct robot_position& in_target_pos, enum e_speed& in_speed,
        enum e_movement_type& in_movement_type)=0;
  };
  ...
  public:
    ...
    void update_command(struct robot_position in_target_pos, enum e_speed in_speed,
        enum e_movement_type in_movement_type);
    void save_to_file(struct robot_position& in_target_pos, enum e_speed& in_speed,
        enum e_movement_type& in_movement_type);
  };
