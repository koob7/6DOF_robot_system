...
void init_main_left_menu() {
  ...
  main_left_menu.add_background_part(
      std::make_shared<rectangle>(0, 0, 120, 480, left_menu_background_color,
          20));
  int pos_y = 89;
  std::string names[8] = {  "OPEN", "CONT. JOB", "MANUAL",
      "ENABLE TOOL", "RUN JOB", "AXIS CONTROL", "CONT. MOVEMENT", "SETTINGS" };
  // przyciski po lewej
...
void init_main_right_menu() {
  ...
  // przycisk z rączką
  main_right_menu.add_part(button(12, 696, pos_y, 48, 47, right_menu_button_color, 10, "+", 0x4A69, right_menu_font));
  main_right_menu.add_part(button(13, 738, pos_y, 48, 47, right_menu_button_color, 10, "-", 0x4A69, right_menu_font));
  main_right_menu.add_part(std::make_shared<rectangle>(740, pos_y, 2, 47, 0x0000));
  main_right_menu.add_part(std::make_shared<image>(721, 353, hand_icon_x, hand_icon_y, hand_icon, false));


  main_right_menu.add_part(button(14, 696, 413, 48, 47, right_menu_button_color, 10, "+", 0x4A69, right_menu_font));
  main_right_menu.add_part(button(15, 738, 413, 48, 47, right_menu_button_color, 10, "-", 0x4A69, right_menu_font));
  main_right_menu.add_part(std::make_shared<rectangle>(740, 413, 2, 47, 0x0000));
  main_right_menu.add_part(std::make_shared<triangle>(732, 417, 732, 417 + 38, 732 + 24, 417 + 19, right_menu_text_color));
